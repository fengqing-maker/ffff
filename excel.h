...
//2018-11-12 CZZ
// #import "mso.dll" rename("RGB","MSO_EXCEL_RGB") rename("DocumentProperties","MSO_EXCEL_DOUCMENTPROPERTIES")
// using namespace Office;
// 
// #import "VBE6EXT.OLB" rename_namespace("VBIDE")
// using namespace  VBIDE;
// 
// #import "EXCEL.EXE" rename("DialogBox","ExcelDialog") rename("RGB","ExcelRGB") rename("CopyFile","ExcelCopyFile") rename("ReplaceText","ExcelReplaceText") no_auto_exclude 
